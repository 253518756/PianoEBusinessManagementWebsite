        ...
        <div class="container">
            <div class="form-box">
                <el-form ref="form" :model="form" label-width="80px">
                    ...
                    <el-form-item>
                        <el-button type="primary" @click="addMerchantRequest">表单提交</el-button>
...
export default {
    ...
    methods: {
        addMerchantRequest: async function (){
            let params = {
            ...
            var response = await http.post(api.merchant_insert, params);
