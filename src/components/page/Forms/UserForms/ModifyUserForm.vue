        ...
        <div class="container">
            <div class="form-box">
                <el-form ref="form" :model="form" label-width="80px">
                    ...
                    <el-form-item>
                        <el-button type="primary" @click="updateUserRequest">表单提交</el-button>
...
export default {
    ...
    methods: {
        ...
        updateUserRequest: async function (){
            let params = {
                userId: this.$route.query.id,
                userAccount: this.$route.query.account,
            ...
            console.log(params)
            var response = await http.post(api.user_update, params);
