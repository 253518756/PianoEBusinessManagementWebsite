...
export async function searchRequest(params,callback) {
    ...
    // 商户登录请求
    let response = await http.post(api.merchant_search, params);
...
export async function insertRequest(params,callback) {
    ...
    // 商户登录请求
    let response = await http.post(api.merchant_insert, params);
...
export async function updateRequest(params,callback) {
    ...
    // 商户登录请求
    let response = await http.post(api.merchant_update, params);
...
export async function deleteRequest(params,callback,index) {
    ...
    // 商户登录请求
    let response = await http.post(api.merchant_delete, params);
